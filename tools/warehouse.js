...
;(function(){
  ...
  /* the raycast needs no player — cast straight from world coordinates */
  shot('THE PALACE — the warehouse shed from its doorway',
       new THREE.Vector3(0, 1.7, -18.6), new THREE.Vector3(0, 2.2, -27),
       13, 7.0, -0.4, 104, 24, [world]);
  shot('THE ARC — the shed from the main house rear door',
       new THREE.Vector3(394, 1.7, -48.2), new THREE.Vector3(420, 2.4, -55),
       26, 7.0, -0.4, 104, 24, [ARC.group]);
})();
`;
